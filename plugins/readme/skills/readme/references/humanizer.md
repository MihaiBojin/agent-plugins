Vendored from [blader/humanizer](https://github.com/blader/humanizer), version
3.0.0 at commit `9862685f575c65a8247f90369951df1b3416e3d6`, retrieved
2026-09-11. MIT, Copyright (c) 2025 Siqi Chen. The notice the licence requires
to travel with it is in `humanizer-LICENSE` beside this file, and the pin is in
`humanizer-VENDOR.json`. Everything below the rule is that file's body,
verbatim, and changes here come from a refresh rather than from an edit.
